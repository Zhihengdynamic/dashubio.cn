...
import com.dashubio.ui.view.ActionSheetDialog;
 ...
 * 身份证Dialog
 */
public class IDCardDialogFragment extends DialogFragment implements View.OnClickListener, NationChoiceDialogFragment.NationChoiceListener {
...
//以下数组未核对
    ...
    public static IDCardDialogFragment newInstance(IDCard idCard) {
        final IDCardDialogFragment fragment = new IDCardDialogFragment();

        final Bundle args = new Bundle();
        args.putSerializable(KEY_CONTENT, idCard);
        fragment.setArguments(args);

        return fragment;
    }

    public IDCardDialogFragment() {
    }
    ...
    TextView mGenderEt;//性别

    @BindView(R.id.folk_et)
    EditText mFolkEt;//民族

    @BindView(R.id.birth_et)
    EditText mBirthEt;//生日

    @BindView(R.id.address_et)
    EditText mAddressEt;//地址

    @BindView(R.id.id_number_et)
    EditText mIDNumberEt;//身份证号

    @BindView(R.id.phone_number_et)
    EditText mPhoneNumberEt;//手机号码

    @BindView(R.id.edt_contacts_number)
    EditText mContactsNumber;//常用联系人
    ...
    @BindView(R.id.lay_mingzu)
    LinearLayout layMingzu;
    @BindView(R.id.lay_chusheng)
    LinearLayout layChusheng;
    @BindView(R.id.lay_diqu)
    LinearLayout layDiqu;
    @BindView(R.id.lay_dizhi)
    LinearLayout layDizhi;
    @BindView(R.id.lay_mphone)
    LinearLayout layMphone;

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        mIDCard = getArguments() != null ? (IDCard) getArguments().getSerializable(KEY_CONTENT) : null;
        mCalendar = Calendar.getInstance();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View v = inflater.inflate(R.layout.dialog_id_card, container, false);
        unbinder = ButterKnife.bind(this, v);
        if (WifiUtils.isNetworkConnected(getActivity())) {
            layXingbie.setVisibility(View.VISIBLE);
            layMingzu.setVisibility(View.VISIBLE);
            layChusheng.setVisibility(View.VISIBLE);
            layChusheng.setVisibility(View.VISIBLE);
            layDiqu.setVisibility(View.VISIBLE);
            layDizhi.setVisibility(View.VISIBLE);
            layMphone.setVisibility(View.VISIBLE);
        }else {
            layXingbie.setVisibility(View.GONE);
            layMingzu.setVisibility(View.GONE);
            layChusheng.setVisibility(View.GONE);
            layChusheng.setVisibility(View.GONE);
            layDiqu.setVisibility(View.GONE);
            layDizhi.setVisibility(View.GONE);
            layMphone.setVisibility(View.GONE);
        }
        ...
        provinceSpinner = (Spinner) v.findViewById(R.id.spin_province);
        citySpinner = (Spinner) v.findViewById(R.id.spin_city);
        countySpinner = (Spinner) v.findViewById(R.id.spin_county);
    ...
    */
    ...
    private void initUI() {
        ...
        if (mIDCard != null) {
            mNameEt.setText(mIDCard.getName());
            mGenderEt.setText(mIDCard.getSex());
            mFolkEt.setText(mIDCard.getFolk());
            mBirthEt.setText(mIDCard.getBirthday());
            mAddressEt.setText(mIDCard.getAddress());
            mIDNumberEt.setText(mIDCard.getCardno());
        }

        mFolkEt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                NationChoiceDialogFragment dialog = NationChoiceDialogFragment.newInstance(mFolkEt.getText().toString());
                dialog.setNationChoiceListener(IDCardDialogFragment.this);
                FragmentTransaction ft = getFragmentManager().beginTransaction();
                ft.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE);
                dialog.show(ft, "NationChoiceDialogFragment");
            }
        });
            ...
            public void onClick(View v) {
                DatePickerDialog dpd = new DatePickerDialog(getActivity(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        String dataStr = year + "年" + month + "月" + day + "日";
                        mBirthEt.setText(dataStr);
                    }
    ...
    @Override
    public void onNationChoiceSingleChoiceComplete(String nation) {
        mFolkEt.setText(nation);
    }
            ...
            case R.id.saveBtn:
                ...
                if (WifiUtils.isNetworkConnected(getActivity())){
                    if (TextUtils.isEmpty(nameStr)) {
                        ToastUtils.show(getActivity(), R.string.username_cannot_empty);
                        return;
                    }
                }
                // nameStr = nameStr == null ? "" : nameStr;

                mIDCard.setName(nameStr);

                String genderStr = mGenderEt.getText().toString();
                // genderStr = genderStr == null ? "" : genderStr;
                if (WifiUtils.isNetworkConnected(getActivity())){

                    /*if (TextUtils.isEmpty(genderStr)) {
                    ToastUtils.show(getActivity(), R.string.user_gender_cannot_empty);
                    return;
                }*/
                }
                mIDCard.setSex(genderStr);

                String folkStr = mFolkEt.getText().toString();
                // folkStr = folkStr == null ? "" : folkStr;
                if (WifiUtils.isNetworkConnected(getActivity())) {

                    /*if (TextUtils.isEmpty(folkStr)) {
                        ToastUtils.show(getActivity(), R.string.user_nation_cannot_empty);
                        return;
                    }*/
                }
                mIDCard.setFolk(folkStr);

                String birthStr = mBirthEt.getText().toString();
                // birthStr = birthStr == null ? "" : birthStr;
                if (WifiUtils.isNetworkConnected(getActivity())) {

                    /*if (TextUtils.isEmpty(birthStr)) {
                        ToastUtils.show(getActivity(), R.string.user_birthday_cannot_empty);
                        return;
                    }*/
                }
                mIDCard.setBirthday(birthStr);
                ...
                if (WifiUtils.isNetworkConnected(getActivity())) {
                    ...
                    /*if (TextUtils.isEmpty(addressStr)) {
                        ToastUtils.show(getActivity(), R.string.user_address_cannot_empty);
                        return;
                    }*/
                }
                mIDCard.setAddress(addressStr);

                String idNumberStr = mIDNumberEt.getText().toString();
                //idNumberStr = idNumberStr == null ? "" : idNumberStr;
                if (WifiUtils.isNetworkConnected(getActivity())) {
                    if (TextUtils.isEmpty(idNumberStr)) {
                        ToastUtils.show(getActivity(), R.string.user_id_card_cannot_empty);
                        return;
                    }
                }

                mIDCard.setCardno(idNumberStr);

                /*if (isIDCard(idNumberStr)) {
                } else {
                    ToastUtils.show(getActivity(), "身份证格式不对");
                    return;
                }*/


                String phoneNumberStr = mPhoneNumberEt.getText().toString();

                if (WifiUtils.isNetworkConnected(getActivity())) {
                    //phoneNumberStr = phoneNumberStr == null ? "" : phoneNumberStr;
                    if (TextUtils.isEmpty(phoneNumberStr)) {
                        ToastUtils.show(getActivity(), R.string.phone_cannot_empty);

                        return;
                    }
                }
                mIDCard.setPhone(phoneNumberStr);
               ...
               /* if (isMobileNO(phoneNumberStr)) {
                ...
                String phoneContactsNumber = mContactsNumber.getText().toString();
                if (WifiUtils.isNetworkConnected(getActivity())) {

                    /*if (TextUtils.isEmpty(phoneContactsNumber)) {
                        ToastUtils.show(getActivity(), R.string.phone_cannot_empty);
                        return;
                    }*/
                }
                mIDCard.setMphone(phoneContactsNumber);
                Log.d("AD", phoneContactsNumber);

                String mprovince = provinceSpinner.getSelectedItem().toString();
                mIDCard.setProvince(mprovince);
                String mcity = citySpinner.getSelectedItem().toString();
                mIDCard.setCity(mcity);
                String mdistrict = countySpinner.getSelectedItem().toString();
                mIDCard.setDistrict(mdistrict);


                if (WifiUtils.isNetworkConnected(getActivity())) {
                    EventBus.getDefault().post(new AutoRegisterMessageEvent(mIDCard));
                } else {
                    //如果没有网络连接，则将姓名，手机号码，身份证号码存入本地数据库
                    DBManager dbManager = new DBManager(getActivity());
                    dbManager.addUserName(nameStr, null, idNumberStr, phoneNumberStr);
                }
                ...
                new ActionSheetDialog(getActivity())
                        ...
                        .addSheetItem(getString(R.string.male), ActionSheetDialog.SheetItemColor.Blue,
                                new ActionSheetDialog.OnSheetItemClickListener() {
                                    ...
                                    public void onClick(int which) {
                                        mGenderEt.setText(R.string.male);
                                    }
                                })
                        .addSheetItem(getString(R.string.female), ActionSheetDialog.SheetItemColor.Blue,
                                new ActionSheetDialog.OnSheetItemClickListener() {
                                    @Override
                                    public void onClick(int which) {
                                        mGenderEt.setText(R.string.female);
                                    }
                                }).show();
                break;
