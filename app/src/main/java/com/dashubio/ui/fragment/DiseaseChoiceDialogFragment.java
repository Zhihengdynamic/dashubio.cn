 ...
 * 疾病选择
 */
public class DiseaseChoiceDialogFragment extends DialogFragment {
     ...
     */
    public static DiseaseChoiceDialogFragment newInstance(String nation) {
        final DiseaseChoiceDialogFragment f = new DiseaseChoiceDialogFragment();
     ...
     */
    public DiseaseChoiceDialogFragment() {
    }
     ...
     * {@link DiseaseChoiceDialogFragment#newInstance(String)} to create this fragment.
     */
    @Override
