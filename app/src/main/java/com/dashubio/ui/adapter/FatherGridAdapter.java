 ...
 * 选择的疾病Grid
 */
public class FatherGridAdapter extends BaseAdapter {
    ...
    /* 构造函数 */
    public FatherGridAdapter(Context context, List<HealthFilesItem> dataList, ActionListener actionListener) {
