 ...
 * 选择的疾病Grid
 */
public class MotherGridAdapter extends BaseAdapter {
    ...
    /* 构造函数 */
    public MotherGridAdapter(Context context, List<HealthFilesItem> dataList, ActionListener actionListener) {
