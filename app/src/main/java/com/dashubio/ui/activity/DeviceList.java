...
/*import whealthService.HealthApi;
import whealthService.OnBLEService;*/
...
public class DeviceList extends Activity implements HealthApi.BleCallBack{
    ...
    public static final String BLUETOOTH_DEVICE_KEY = "BluetoothDeviceKey";
	...
	private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case OnBLEService.GATT_DEVICE_FOUND_MSG:
                Log.i(TAG, "handleMessage()------>OnBLEService.GATT_DEVICE_FOUND_MSG");
...
//            }
            ...
            b.putParcelable(BLUETOOTH_DEVICE_KEY, device);
