package com.dashubio.card.utils;
...
public class HttpUtil {
   ...
   /* public static final String USERNAME="5c7fa804-7645-4682-aaf6-c14f10ea711e";//开发者平台API帐号
    public static final String PASSWORD="rjMxCAunukRYBNcsWsDtECOzcsltBF";//开发者平台API密码*/
    ...
    /*public static final String USERNAME="637db859-1b01-479e-b3b1-6f59c1b7a342";//开发者平台API帐号
    public static final String PASSWORD="xuXrwQwesaDyUeGGeaOlQZNIJikogU";//开发者平台API密码*/
    ...
    public static String getSendXML(String action, String ext) {
        ...
        //返回结果是否转成json格式，不传及默认是xml格式，为1时转换成json格式
