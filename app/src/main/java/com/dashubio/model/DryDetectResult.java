...
public class DryDetectResult implements Serializable {
    ...
    public static DryDetectResult parseData(String receivedData){
        ...
        Logger.i("deviceNumber = " + deviceNumber);
        ...
        switch (flag){
            case 1: //六项：HDL-C  GLU  TC  TG  VLDL-C  LDL-C
                ...
                Logger.i("HDL = " + HDL + " hdlReal = " + hdlReal);
                ...
                Logger.i("GLU = " + GLU + " gluReal = " + gluReal);
                ...
                Logger.i("VLDL = " + VLDL + " vldlReal = " + vldlReal);
                ...
                Logger.i("LDL = " + LDL + " ldlReal = " + ldlReal);
                break;
            ...
            case 2: //两项：ALT  Hb
                ...
                Logger.i("ALT = " + ALT + " altReal = " + altReal);
            ...
            case 3: //单项：ALT
                ...
                Logger.i("individualALT = " + individualALT + " individualALTReal = " + individualALTReal);
                break;
            ...
            case 4: //单项：Hb
                ...
                Logger.i("individualHb = " + individualHb);
                break;
        }
